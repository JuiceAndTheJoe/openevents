...
- **Endpoint URL:** `https://team2-openeventstorage.minio-minio.auto.prod.osaas.io`
- **Access Key:** `openevents`
- **Secret Key:** `OpenEvents2024Storage!`
...
1. Open the MinIO Console in your browser:
   ```
   https://team2-openeventstorage.minio-minio.auto.prod.osaas.io
   ```

2. Log in with the credentials:
   - **Username:** `openevents`
   - **Password:** `OpenEvents2024Storage!`
...
export AWS_SECRET_ACCESS_KEY="OpenEvents2024Storage!"
...
mc alias set openevents https://team2-openeventstorage.minio-minio.auto.prod.osaas.io openevents "OpenEvents2024Storage!"
...
```env
S3_ENDPOINT=https://team2-openeventstorage.minio-minio.auto.prod.osaas.io
S3_PUBLIC_URL=https://team2-openeventstorage.minio-minio.auto.prod.osaas.io
S3_ACCESS_KEY_ID=openevents
S3_SECRET_ACCESS_KEY=OpenEvents2024Storage!
